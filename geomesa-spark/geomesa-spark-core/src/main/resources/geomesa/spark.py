...
class SpatialRDDProvider:
    ...
    def rdd_geojson(self, typename, ecql):
        return self.rdd(typename, ecql, self.jvm.JavaSpatialRDDProvider.GeoJSONStringTransform)

    def rdd_dict(self, typename, ecql):
        return self.rdd(typename, ecql, self.jvm.JavaSpatialRDDProvider.PyMapTransform)
